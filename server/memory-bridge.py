    ...
    def do_POST(self):
        ...
        try:
            ...
            if path == "/memory/write":
                ...
                self.end_headers()
                self.wfile.write(
                    json.dumps({"success": True, "id": mem_id, "longterm": longterm}).encode()
                )
                                ...
                                serializable_results.append(
                                    {
                                        ...
                                        "score": 0.95,
                                        "timestamp": fact_value.get(
                                            "timestamp", fact_data.get("stored_at", "")
                                        ),
                                    }
                                )
                ...
                self.end_headers()
                self.wfile.write(
                    json.dumps({"success": True, "results": serializable_results}).encode()
                )
                ...
                json.dumps(
                    {
                        ...
                        "status": {
                            ...
                            "total_entries": stats["short_term_count"]
