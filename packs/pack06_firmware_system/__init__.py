...
class FirmwarePackager:
    ...
    def package(self, source_path: str, name: str, version: str, 
                architecture: str = "universal") -> FirmwareImage:
    ...
    def _build_header(self, name: str, version: str, arch: str, 
                      size: int, checksum: str) -> bytes:
...
class FirmwareManager:
    ...
    def create_firmware(self, source: str, name: str, version: str, 
                        arch: str = "universal") -> FirmwareImage:
