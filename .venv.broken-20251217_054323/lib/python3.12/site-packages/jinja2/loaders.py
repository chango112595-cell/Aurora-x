...
class FileSystemLoader(BaseLoader):
    ...
    def get_source(self, environment: "Environment", template: str) -> tuple[str, str, t.Callable[[], bool]]:
...
class PackageLoader(BaseLoader):
    ...
    def get_source(self, environment: "Environment", template: str) -> tuple[str, str, t.Callable[[], bool] | None]:
        # Use posixpath even on Windows to avoid "drive:" or UNC
...
class DictLoader(BaseLoader):
    ...
    def get_source(self, environment: "Environment", template: str) -> tuple[str, None, t.Callable[[], bool]]:
