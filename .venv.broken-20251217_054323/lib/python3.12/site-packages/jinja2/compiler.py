...
class CodeGenerator(NodeVisitor):
    ...
    def macro_body(self, node: nodes.Macro | nodes.CallBlock, frame: Frame) -> tuple[Frame, MacroRef]:
    ...
    def _import_common(self, node: nodes.Import | nodes.FromImport, frame: Frame) -> None:
    ...
    @contextmanager
    def _filter_test_common(self, node: nodes.Filter | nodes.Test, frame: Frame, is_filter: bool) -> t.Iterator[None]:
        if self.environment.is_async:
            self.write("(await auto_await(")
