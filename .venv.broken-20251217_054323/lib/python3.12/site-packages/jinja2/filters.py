...
def sync_do_slice(value: "t.Collection[V]", slices: int, fill_with: "V | None" = None) -> "t.Iterator[list[V]]":
...
def do_batch(value: "t.Iterable[V]", linecount: int, fill_with: "V | None" = None) -> "t.Iterator[list[V]]":
    """
...
def prepare_map(context: "Context", args: tuple[t.Any, ...], kwargs: dict[str, t.Any]) -> t.Callable[[t.Any], t.Any]:
