...
class Monitor0299Execute:
    """
    Execution handler for Monitor Module 30 - Threat Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "threat-monitor"]
...
def execute(
    ...
    handler = Monitor0299Execute(payload, context)
