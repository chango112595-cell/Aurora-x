...
class Monitor0379Execute:
    """
    Execution handler for Monitor Module 38 - Rollback Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "rollback-monitor"]
...
def execute(
    ...
    handler = Monitor0379Execute(payload, context)
