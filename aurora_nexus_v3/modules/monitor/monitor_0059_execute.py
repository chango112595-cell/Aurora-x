...
class Monitor0059Execute:
    """
    Execution handler for Monitor Module 6 - Disk Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "disk-monitor"]
...
def execute(
    ...
    handler = Monitor0059Execute(payload, context)
