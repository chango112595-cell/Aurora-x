...
class Monitor0159Execute:
    """
    Execution handler for Monitor Module 16 - Availability Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "availability-monitor"]
...
def execute(
    ...
    handler = Monitor0159Execute(payload, context)
