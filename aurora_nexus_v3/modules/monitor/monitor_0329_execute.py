...
class Monitor0329Execute:
    """
    Execution handler for Monitor Module 33 - Change Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "change-monitor"]
...
def execute(
    ...
    handler = Monitor0329Execute(payload, context)
