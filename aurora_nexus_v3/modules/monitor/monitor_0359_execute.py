...
class Monitor0359Execute:
    """
    Execution handler for Monitor Module 36 - Deployment Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "deployment-monitor"]
...
def execute(
    ...
    handler = Monitor0359Execute(payload, context)
