...
class Monitor0249Execute:
    """
    Execution handler for Monitor Module 25 - Session Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "session-monitor"]
...
def execute(
    ...
    handler = Monitor0249Execute(payload, context)
