...
class Monitor0149Execute:
    """
    Execution handler for Monitor Module 15 - Uptime Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "uptime-monitor"]
...
def execute(
    ...
    handler = Monitor0149Execute(payload, context)
