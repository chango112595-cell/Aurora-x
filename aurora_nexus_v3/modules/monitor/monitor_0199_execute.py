...
class Monitor0199Execute:
    """
    Execution handler for Monitor Module 20 - Cache Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "cache-monitor"]
...
def execute(
    ...
    handler = Monitor0199Execute(payload, context)
