...
class Monitor0219Execute:
    """
    Execution handler for Monitor Module 22 - Query Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "query-monitor"]
...
def execute(
    ...
    handler = Monitor0219Execute(payload, context)
