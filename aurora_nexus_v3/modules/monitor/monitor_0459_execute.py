...
class Monitor0459Execute:
    """
    Execution handler for Monitor Module 46 - SLA Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "sla-monitor"]
...
def execute(
    ...
    handler = Monitor0459Execute(payload, context)
