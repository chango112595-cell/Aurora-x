...
class Monitor0139Execute:
    """
    Execution handler for Monitor Module 14 - Health Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "health-monitor"]
...
def execute(
    ...
    handler = Monitor0139Execute(payload, context)
