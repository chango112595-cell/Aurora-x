...
class Monitor0039Execute:
    """
    Execution handler for Monitor Module 4 - Memory Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "memory-monitor"]
...
def execute(
    ...
    handler = Monitor0039Execute(payload, context)
