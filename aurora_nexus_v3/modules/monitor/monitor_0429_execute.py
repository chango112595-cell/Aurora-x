...
class Monitor0429Execute:
    """
    Execution handler for Monitor Module 43 - Experiment Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ['monitoring', 'observability', 'alerting', 'experiment-monitor']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Monitor0429Execute(payload, context)
