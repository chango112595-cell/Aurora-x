...
class Monitor0349Execute:
    """
    Execution handler for Monitor Module 35 - Version Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "version-monitor"]
...
def execute(
    ...
    handler = Monitor0349Execute(payload, context)
