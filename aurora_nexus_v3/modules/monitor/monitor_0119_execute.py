...
class Monitor0119Execute:
    """
    Execution handler for Monitor Module 12 - Event Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "event-monitor"]
...
def execute(
    ...
    handler = Monitor0119Execute(payload, context)
