...
class Monitor0389Execute:
    """
    Execution handler for Monitor Module 39 - Canary Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "canary-monitor"]
...
def execute(
    ...
    handler = Monitor0389Execute(payload, context)
