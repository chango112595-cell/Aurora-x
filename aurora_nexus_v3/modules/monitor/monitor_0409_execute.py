...
class Monitor0409Execute:
    """
    Execution handler for Monitor Module 41 - A/B Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "a/b-monitor"]
...
def execute(
    ...
    handler = Monitor0409Execute(payload, context)
