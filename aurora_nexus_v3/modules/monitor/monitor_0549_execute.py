...
class Monitor0549Execute:
    """
    Execution handler for Monitor Module 55 - Capacity Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "capacity-monitor"]
...
def execute(
    ...
    handler = Monitor0549Execute(payload, context)
