...
class Monitor0229Execute:
    """
    Execution handler for Monitor Module 23 - Connection Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "connection-monitor"]
...
def execute(
    ...
    handler = Monitor0229Execute(payload, context)
