...
class Monitor0439Execute:
    """
    Execution handler for Monitor Module 44 - Metrics Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "metrics-monitor"]
...
def execute(
    ...
    handler = Monitor0439Execute(payload, context)
