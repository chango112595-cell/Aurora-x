...
class Monitor0449Execute:
    """
    Execution handler for Monitor Module 45 - KPI Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "kpi-monitor"]
...
def execute(
    ...
    handler = Monitor0449Execute(payload, context)
