...
class Monitor0239Execute:
    """
    Execution handler for Monitor Module 24 - Pool Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "pool-monitor"]
...
def execute(
    ...
    handler = Monitor0239Execute(payload, context)
