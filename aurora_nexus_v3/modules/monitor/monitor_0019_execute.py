...
class Monitor0019Execute:
    """
    Execution handler for Monitor Module 2 - Process Monitor.
    Category: monitor
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["monitoring", "observability", "alerting", "process-monitor"]
...
def execute(
    ...
    handler = Monitor0019Execute(payload, context)
