...
class Analyzer0323Execute:
    """
    Execution handler for Analyzer Module 33 - Schema Validator.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "schema-validator"]
...
def execute(
    ...
    handler = Analyzer0323Execute(payload, context)
