...
class Analyzer0333Execute:
    """
    Execution handler for Analyzer Module 34 - Contract Verifier.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "contract-verifier"]
...
def execute(
    ...
    handler = Analyzer0333Execute(payload, context)
