...
class Analyzer0353Execute:
    """
    Execution handler for Analyzer Module 36 - Response Validator.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "response-validator"]
...
def execute(
    ...
    handler = Analyzer0353Execute(payload, context)
