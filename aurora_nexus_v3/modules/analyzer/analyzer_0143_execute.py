...
class Analyzer0143Execute:
    """
    Execution handler for Analyzer Module 15 - Throughput Calc.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "throughput-calc"]
...
def execute(
    ...
    handler = Analyzer0143Execute(payload, context)
