...
class Analyzer0263Execute:
    """
    Execution handler for Analyzer Module 27 - Duplication Finder.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "duplication-finder"]
...
def execute(
    ...
    handler = Analyzer0263Execute(payload, context)
