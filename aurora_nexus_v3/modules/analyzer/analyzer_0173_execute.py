...
class Analyzer0173Execute:
    """
    Execution handler for Analyzer Module 18 - Vulnerability Scanner.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "vulnerability-scanner"]
...
def execute(
    ...
    handler = Analyzer0173Execute(payload, context)
