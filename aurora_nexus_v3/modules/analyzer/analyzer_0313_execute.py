...
class Analyzer0313Execute:
    """
    Execution handler for Analyzer Module 32 - Type Checker.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "type-checker"]
...
def execute(
    ...
    handler = Analyzer0313Execute(payload, context)
