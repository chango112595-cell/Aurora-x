...
class Analyzer0073Execute:
    """
    Execution handler for Analyzer Module 8 - Profile Inspector.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "profile-inspector"]
...
def execute(
    ...
    handler = Analyzer0073Execute(payload, context)
