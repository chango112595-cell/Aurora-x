...
class Analyzer0363Execute:
    """
    Execution handler for Analyzer Module 37 - Request Analyzer.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "request-analyzer"]
...
def execute(
    ...
    handler = Analyzer0363Execute(payload, context)
