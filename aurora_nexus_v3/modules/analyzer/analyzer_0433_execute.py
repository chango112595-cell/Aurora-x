...
class Analyzer0433Execute:
    """
    Execution handler for Analyzer Module 44 - Heatmap Generator.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "heatmap-generator"]
...
def execute(
    ...
    handler = Analyzer0433Execute(payload, context)
