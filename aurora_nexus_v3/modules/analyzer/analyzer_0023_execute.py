...
class Analyzer0023Execute:
    """
    Execution handler for Analyzer Module 3 - Anomaly Finder.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ['analysis', 'insights', 'diagnostics', 'anomaly-finder']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Analyzer0023Execute(payload, context)
