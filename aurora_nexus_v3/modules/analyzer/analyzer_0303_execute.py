...
class Analyzer0303Execute:
    """
    Execution handler for Analyzer Module 31 - Lint Engine.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "lint-engine"]
...
def execute(
    ...
    handler = Analyzer0303Execute(payload, context)
