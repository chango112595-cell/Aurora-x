...
class Analyzer0343Execute:
    """
    Execution handler for Analyzer Module 35 - API Analyzer.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "api-analyzer"]
...
def execute(
    ...
    handler = Analyzer0343Execute(payload, context)
