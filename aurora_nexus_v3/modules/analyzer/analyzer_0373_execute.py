...
class Analyzer0373Execute:
    """
    Execution handler for Analyzer Module 38 - Header Inspector.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "header-inspector"]
...
def execute(
    ...
    handler = Analyzer0373Execute(payload, context)
