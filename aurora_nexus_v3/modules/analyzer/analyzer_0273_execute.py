...
class Analyzer0273Execute:
    """
    Execution handler for Analyzer Module 28 - Dead Code Detector.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "dead-code-detector"]
...
def execute(
    ...
    handler = Analyzer0273Execute(payload, context)
