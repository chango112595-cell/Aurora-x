...
class Analyzer0463Execute:
    """
    Execution handler for Analyzer Module 47 - Retention Calc.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "retention-calc"]
...
def execute(
    ...
    handler = Analyzer0463Execute(payload, context)
