...
class Analyzer0293Execute:
    """
    Execution handler for Analyzer Module 30 - Style Checker.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ['analysis', 'insights', 'diagnostics', 'style-checker']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Analyzer0293Execute(payload, context)
