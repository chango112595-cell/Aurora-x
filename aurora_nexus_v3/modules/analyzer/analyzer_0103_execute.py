...
class Analyzer0103Execute:
    """
    Execution handler for Analyzer Module 11 - Network Sniffer.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "network-sniffer"]
...
def execute(
    ...
    handler = Analyzer0103Execute(payload, context)
