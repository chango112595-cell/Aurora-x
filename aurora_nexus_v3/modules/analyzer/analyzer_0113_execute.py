...
class Analyzer0113Execute:
    """
    Execution handler for Analyzer Module 12 - Packet Inspector.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "packet-inspector"]
...
def execute(
    ...
    handler = Analyzer0113Execute(payload, context)
