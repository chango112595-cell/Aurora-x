...
class Analyzer0233Execute:
    """
    Execution handler for Analyzer Module 24 - Import Analyzer.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "import-analyzer"]
...
def execute(
    ...
    handler = Analyzer0233Execute(payload, context)
