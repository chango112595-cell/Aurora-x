...
class Analyzer0083Execute:
    """
    Execution handler for Analyzer Module 9 - Memory Analyzer.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "memory-analyzer"]
...
def execute(
    ...
    handler = Analyzer0083Execute(payload, context)
