...
class Analyzer0193Execute:
    """
    Execution handler for Analyzer Module 20 - Compliance Checker.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "compliance-checker"]
...
def execute(
    ...
    handler = Analyzer0193Execute(payload, context)
