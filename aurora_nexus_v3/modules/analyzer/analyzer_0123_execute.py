...
class Analyzer0123Execute:
    """
    Execution handler for Analyzer Module 13 - Traffic Analyzer.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "traffic-analyzer"]
...
def execute(
    ...
    handler = Analyzer0123Execute(payload, context)
