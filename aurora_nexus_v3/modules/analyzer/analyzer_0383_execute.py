...
class Analyzer0383Execute:
    """
    Execution handler for Analyzer Module 39 - Cookie Analyzer.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "cookie-analyzer"]
...
def execute(
    ...
    handler = Analyzer0383Execute(payload, context)
