...
class Analyzer0043Execute:
    """
    Execution handler for Analyzer Module 5 - Metric Calculator.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "metric-calculator"]
...
def execute(
    ...
    handler = Analyzer0043Execute(payload, context)
