...
class Analyzer0203Execute:
    """
    Execution handler for Analyzer Module 21 - Quality Assessor.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ['analysis', 'insights', 'diagnostics', 'quality-assessor']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Analyzer0203Execute(payload, context)
