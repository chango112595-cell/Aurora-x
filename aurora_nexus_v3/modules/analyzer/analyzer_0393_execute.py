...
class Analyzer0393Execute:
    """
    Execution handler for Analyzer Module 40 - Session Tracker.
    Category: analyzer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["analysis", "insights", "diagnostics", "session-tracker"]
...
def execute(
    ...
    handler = Analyzer0393Execute(payload, context)
