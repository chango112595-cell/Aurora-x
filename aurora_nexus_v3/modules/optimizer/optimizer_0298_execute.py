"""
Aurora-X Module: M0298 - Optimizer Module 30 - Lazy Loader
Category: optimizer
...
class Optimizer0298Execute:
    """
    Execution handler for Optimizer Module 30 - Lazy Loader.
    Category: optimizer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["optimization", "performance", "efficiency", "lazy-loader"]
...
def execute(
    ...
    handler = Optimizer0298Execute(payload, context)
