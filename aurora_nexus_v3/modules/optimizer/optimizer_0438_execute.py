"""
Aurora-X Module: M0438 - Optimizer Module 44 - NUMA Optimizer
Category: optimizer
...
class Optimizer0438Execute:
    """
    Execution handler for Optimizer Module 44 - NUMA Optimizer.
    Category: optimizer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["optimization", "performance", "efficiency", "numa-optimizer"]
...
def execute(
    ...
    handler = Optimizer0438Execute(payload, context)
