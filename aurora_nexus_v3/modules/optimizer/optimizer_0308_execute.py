"""
Aurora-X Module: M0308 - Optimizer Module 31 - Connection Pooler
Category: optimizer
...
class Optimizer0308Execute:
    """
    Execution handler for Optimizer Module 31 - Connection Pooler.
    Category: optimizer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["optimization", "performance", "efficiency", "connection-pooler"]
...
def execute(
    ...
    handler = Optimizer0308Execute(payload, context)
