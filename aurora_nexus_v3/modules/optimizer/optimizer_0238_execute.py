"""
Aurora-X Module: M0238 - Optimizer Module 24 - Branch Optimizer
Category: optimizer
...
class Optimizer0238Execute:
    """
    Execution handler for Optimizer Module 24 - Branch Optimizer.
    Category: optimizer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["optimization", "performance", "efficiency", "branch-optimizer"]
...
def execute(
    ...
    handler = Optimizer0238Execute(payload, context)
