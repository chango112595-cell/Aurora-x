"""
Aurora-X Module: M0108 - Optimizer Module 11 - Resource Optimizer
Category: optimizer
...
class Optimizer0108Execute:
    """
    Execution handler for Optimizer Module 11 - Resource Optimizer.
    Category: optimizer
    Sandbox: wasm
    """
    ...
    SANDBOX_TYPE = "wasm"
    TAGS = ["optimization", "performance", "efficiency", "resource-optimizer"]
...
def execute(
    ...
    handler = Optimizer0108Execute(payload, context)
