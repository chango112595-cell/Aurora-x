...
class Processor0012Execute:
    """
    Execution handler for Processor Module 2 - Stream Handler.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ['processing', 'computation', 'workflow', 'stream-handler']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Processor0012Execute(payload, context)
