...
class Processor0462Execute:
    """
    Execution handler for Processor Module 47 - Tree Processor.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ["processing", "computation", "workflow", "tree-processor"]
...
def execute(
    ...
    handler = Processor0462Execute(payload, context)
