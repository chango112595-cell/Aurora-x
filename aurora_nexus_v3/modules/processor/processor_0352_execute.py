...
class Processor0352Execute:
    """
    Execution handler for Processor Module 36 - Collector Module.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ["processing", "computation", "workflow", "collector-module"]
...
def execute(
    ...
    handler = Processor0352Execute(payload, context)
