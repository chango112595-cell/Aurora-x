...
class Processor0252Execute:
    """
    Execution handler for Processor Module 26 - Splitter Engine.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ["processing", "computation", "workflow", "splitter-engine"]
...
def execute(
    ...
    handler = Processor0252Execute(payload, context)
