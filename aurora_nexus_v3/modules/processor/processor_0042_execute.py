...
class Processor0042Execute:
    """
    Execution handler for Processor Module 5 - Task Runner.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ["processing", "computation", "workflow", "task-runner"]
...
def execute(
    ...
    handler = Processor0042Execute(payload, context)
