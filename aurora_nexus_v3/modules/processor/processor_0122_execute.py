...
class Processor0122Execute:
    """
    Execution handler for Processor Module 13 - Rate Limiter.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ["processing", "computation", "workflow", "rate-limiter"]
...
def execute(
    ...
    handler = Processor0122Execute(payload, context)
