...
class Processor0262Execute:
    """
    Execution handler for Processor Module 27 - Merger Processor.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ['processing', 'computation', 'workflow', 'merger-processor']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Processor0262Execute(payload, context)
