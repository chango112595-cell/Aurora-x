...
class Processor0312Execute:
    """
    Execution handler for Processor Module 32 - Flattener.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ["processing", "computation", "workflow", "flattener"]
...
def execute(
    ...
    handler = Processor0312Execute(payload, context)
