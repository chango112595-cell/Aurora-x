...
class Processor0302Execute:
    """
    Execution handler for Processor Module 31 - Denormalizer.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ["processing", "computation", "workflow", "denormalizer"]
...
def execute(
    ...
    handler = Processor0302Execute(payload, context)
