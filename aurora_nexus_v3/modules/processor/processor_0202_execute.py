...
class Processor0202Execute:
    """
    Execution handler for Processor Module 21 - Request Handler.
    Category: processor
    Sandbox: container
    """
    ...
    TAGS = ["processing", "computation", "workflow", "request-handler"]
...
def execute(
    ...
    handler = Processor0202Execute(payload, context)
