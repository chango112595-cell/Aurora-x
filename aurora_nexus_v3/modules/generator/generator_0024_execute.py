"""
Aurora-X Module: M0024 - Generator Module 3 - Scaffold Builder
Category: generator
...
class Generator0024Execute:
    """
    Execution handler for Generator Module 3 - Scaffold Builder.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "scaffold-builder"]
...
def execute(
    ...
    handler = Generator0024Execute(payload, context)
