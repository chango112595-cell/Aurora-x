"""
Aurora-X Module: M0004 - Generator Module 1 - Code Generator
Category: generator
...
class Generator0004Execute:
    """
    Execution handler for Generator Module 1 - Code Generator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "code-generator"]
...
def execute(
    ...
    handler = Generator0004Execute(payload, context)
