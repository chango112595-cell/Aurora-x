"""
Aurora-X Module: M0444 - Generator Module 45 - SMS Template
Category: generator
...
class Generator0444Execute:
    """
    Execution handler for Generator Module 45 - SMS Template.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "sms-template"]
...
def execute(
    ...
    handler = Generator0444Execute(payload, context)
