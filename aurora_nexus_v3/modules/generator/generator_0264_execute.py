"""
Aurora-X Module: M0264 - Generator Module 27 - Thumbnail Creator
Category: generator
...
class Generator0264Execute:
    """
    Execution handler for Generator Module 27 - Thumbnail Creator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "thumbnail-creator"]
...
def execute(
    ...
    handler = Generator0264Execute(payload, context)
