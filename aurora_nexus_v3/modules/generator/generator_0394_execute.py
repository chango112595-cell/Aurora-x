"""
Aurora-X Module: M0394 - Generator Module 40 - Summary Builder
Category: generator
...
class Generator0394Execute:
    """
    Execution handler for Generator Module 40 - Summary Builder.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "summary-builder"]
...
def execute(
    ...
    handler = Generator0394Execute(payload, context)
