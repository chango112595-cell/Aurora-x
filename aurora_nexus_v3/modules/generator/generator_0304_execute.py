"""
Aurora-X Module: M0304 - Generator Module 31 - Graph Generator
Category: generator
...
class Generator0304Execute:
    """
    Execution handler for Generator Module 31 - Graph Generator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "graph-generator"]
...
def execute(
    ...
    handler = Generator0304Execute(payload, context)
