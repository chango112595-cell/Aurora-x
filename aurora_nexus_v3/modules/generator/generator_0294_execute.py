"""
Aurora-X Module: M0294 - Generator Module 30 - Chart Builder
Category: generator
...
class Generator0294Execute:
    """
    Execution handler for Generator Module 30 - Chart Builder.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "chart-builder"]
...
def execute(
    ...
    handler = Generator0294Execute(payload, context)
