"""
Aurora-X Module: M0094 - Generator Module 10 - API Spec Generator
Category: generator
...
class Generator0094Execute:
    """
    Execution handler for Generator Module 10 - API Spec Generator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "api-spec-generator"]
...
def execute(
    ...
    handler = Generator0094Execute(payload, context)
