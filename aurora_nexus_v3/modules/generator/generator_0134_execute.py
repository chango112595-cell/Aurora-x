"""
Aurora-X Module: M0134 - Generator Module 14 - Sample Generator
Category: generator
...
class Generator0134Execute:
    """
    Execution handler for Generator Module 14 - Sample Generator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "sample-generator"]
...
def execute(
    ...
    handler = Generator0134Execute(payload, context)
