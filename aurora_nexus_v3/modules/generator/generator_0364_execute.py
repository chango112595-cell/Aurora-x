"""
Aurora-X Module: M0364 - Generator Module 37 - Invoice Builder
Category: generator
...
class Generator0364Execute:
    """
    Execution handler for Generator Module 37 - Invoice Builder.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ['generation', 'creation', 'automation', 'invoice-builder']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Generator0364Execute(payload, context)
