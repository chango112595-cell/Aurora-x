"""
Aurora-X Module: M0204 - Generator Module 21 - Certificate Creator
Category: generator
...
class Generator0204Execute:
    """
    Execution handler for Generator Module 21 - Certificate Creator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "certificate-creator"]
...
def execute(
    ...
    handler = Generator0204Execute(payload, context)
