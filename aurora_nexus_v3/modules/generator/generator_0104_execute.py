"""
Aurora-X Module: M0104 - Generator Module 11 - Schema Generator
Category: generator
...
class Generator0104Execute:
    """
    Execution handler for Generator Module 11 - Schema Generator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "schema-generator"]
...
def execute(
    ...
    handler = Generator0104Execute(payload, context)
