"""
Aurora-X Module: M0244 - Generator Module 25 - Barcode Creator
Category: generator
...
class Generator0244Execute:
    """
    Execution handler for Generator Module 25 - Barcode Creator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "barcode-creator"]
...
def execute(
    ...
    handler = Generator0244Execute(payload, context)
