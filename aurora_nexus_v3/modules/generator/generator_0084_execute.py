...
class Generator0084Execute:
    """
    Execution handler for Generator Module 9 - Documentation Gen.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ['generation', 'creation', 'automation', 'documentation-gen']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Generator0084Execute(payload, context)
