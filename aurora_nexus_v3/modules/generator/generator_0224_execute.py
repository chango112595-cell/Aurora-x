"""
Aurora-X Module: M0224 - Generator Module 23 - OTP Factory
Category: generator
...
class Generator0224Execute:
    """
    Execution handler for Generator Module 23 - OTP Factory.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "otp-factory"]
...
def execute(
    ...
    handler = Generator0224Execute(payload, context)
