"""
Aurora-X Module: M0374 - Generator Module 38 - Receipt Creator
Category: generator
...
class Generator0374Execute:
    """
    Execution handler for Generator Module 38 - Receipt Creator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "receipt-creator"]
...
def execute(
    ...
    handler = Generator0374Execute(payload, context)
