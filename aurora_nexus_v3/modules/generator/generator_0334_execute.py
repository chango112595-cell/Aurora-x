"""
Aurora-X Module: M0334 - Generator Module 34 - ERD Generator
Category: generator
...
class Generator0334Execute:
    """
    Execution handler for Generator Module 34 - ERD Generator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "erd-generator"]
...
def execute(
    ...
    handler = Generator0334Execute(payload, context)
