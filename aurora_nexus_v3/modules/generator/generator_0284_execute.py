"""
Aurora-X Module: M0284 - Generator Module 29 - Avatar Factory
Category: generator
...
class Generator0284Execute:
    """
    Execution handler for Generator Module 29 - Avatar Factory.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "avatar-factory"]
...
def execute(
    ...
    handler = Generator0284Execute(payload, context)
