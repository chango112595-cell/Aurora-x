"""
Aurora-X Module: M0424 - Generator Module 43 - Message Builder
Category: generator
...
class Generator0424Execute:
    """
    Execution handler for Generator Module 43 - Message Builder.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "message-builder"]
...
def execute(
    ...
    handler = Generator0424Execute(payload, context)
