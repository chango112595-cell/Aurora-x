"""
Aurora-X Module: M0314 - Generator Module 32 - Diagram Creator
Category: generator
...
class Generator0314Execute:
    """
    Execution handler for Generator Module 32 - Diagram Creator.
    Category: generator
    Sandbox: native
    """
    ...
    SANDBOX_TYPE = "native"
    TAGS = ["generation", "creation", "automation", "diagram-creator"]
...
def execute(
    ...
    handler = Generator0314Execute(payload, context)
