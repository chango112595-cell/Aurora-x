...
class Formatter0207Execute:
    """
    Execution handler for Formatter Module 21 - Table Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "table-formatter"]
...
def execute(
    ...
    handler = Formatter0207Execute(payload, context)
