...
class Formatter0237Execute:
    """
    Execution handler for Formatter Module 24 - Tree Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "tree-formatter"]
...
def execute(
    ...
    handler = Formatter0237Execute(payload, context)
