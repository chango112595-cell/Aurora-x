...
class Formatter0117Execute:
    """
    Execution handler for Formatter Module 12 - Java Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "java-formatter"]
...
def execute(
    ...
    handler = Formatter0117Execute(payload, context)
