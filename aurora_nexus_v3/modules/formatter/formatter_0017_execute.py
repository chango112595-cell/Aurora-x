...
class Formatter0017Execute:
    """
    Execution handler for Formatter Module 2 - JSON Prettier.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "json-prettier"]
...
def execute(
    ...
    handler = Formatter0017Execute(payload, context)
