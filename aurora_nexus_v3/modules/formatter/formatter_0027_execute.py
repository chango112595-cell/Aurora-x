...
class Formatter0027Execute:
    """
    Execution handler for Formatter Module 3 - XML Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "xml-formatter"]
...
def execute(
    ...
    handler = Formatter0027Execute(payload, context)
