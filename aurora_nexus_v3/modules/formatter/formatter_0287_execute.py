...
class Formatter0287Execute:
    """
    Execution handler for Formatter Module 29 - Calendar Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "calendar-formatter"]
...
def execute(
    ...
    handler = Formatter0287Execute(payload, context)
