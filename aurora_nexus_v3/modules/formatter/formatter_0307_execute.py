...
class Formatter0307Execute:
    """
    Execution handler for Formatter Module 31 - Invoice Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "invoice-formatter"]
...
def execute(
    ...
    handler = Formatter0307Execute(payload, context)
