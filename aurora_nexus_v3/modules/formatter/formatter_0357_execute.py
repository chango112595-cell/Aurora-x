...
class Formatter0357Execute:
    """
    Execution handler for Formatter Module 36 - Word Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "word-formatter"]
...
def execute(
    ...
    handler = Formatter0357Execute(payload, context)
