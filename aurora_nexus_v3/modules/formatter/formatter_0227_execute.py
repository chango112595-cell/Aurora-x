...
class Formatter0227Execute:
    """
    Execution handler for Formatter Module 23 - List Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "list-formatter"]
...
def execute(
    ...
    handler = Formatter0227Execute(payload, context)
