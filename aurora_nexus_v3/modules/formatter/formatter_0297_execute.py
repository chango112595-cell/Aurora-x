...
class Formatter0297Execute:
    """
    Execution handler for Formatter Module 30 - Schedule Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ["formatting", "presentation", "styling", "schedule-formatter"]
...
def execute(
    ...
    handler = Formatter0297Execute(payload, context)
