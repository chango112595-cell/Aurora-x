...
class Formatter0127Execute:
    """
    Execution handler for Formatter Module 13 - C++ Formatter.
    Category: formatter
    Sandbox: container
    """
    ...
    TAGS = ['formatting', 'presentation', 'styling', 'c++-formatter']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Formatter0127Execute(payload, context)
