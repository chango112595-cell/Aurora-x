...
class Integrator0330Execute:
    """
    Execution handler for Integrator Module 33 - Banking Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "banking-integrator"]
...
def execute(
    ...
    handler = Integrator0330Execute(payload, context)
