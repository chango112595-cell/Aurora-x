...
class Integrator0130Execute:
    """
    Execution handler for Integrator Module 13 - Hybrid Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "hybrid-integrator"]
...
def execute(
    ...
    handler = Integrator0130Execute(payload, context)
