...
class Integrator0360Execute:
    """
    Execution handler for Integrator Module 36 - Education Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "education-integrator"]
...
def execute(
    ...
    handler = Integrator0360Execute(payload, context)
