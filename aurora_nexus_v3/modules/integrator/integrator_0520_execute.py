...
class Integrator0520Execute:
    """
    Execution handler for Integrator Module 52 - Speech Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "speech-integrator"]
...
def execute(
    ...
    handler = Integrator0520Execute(payload, context)
