...
class Integrator0260Execute:
    """
    Execution handler for Integrator Module 26 - ERP Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "erp-integrator"]
...
def execute(
    ...
    handler = Integrator0260Execute(payload, context)
