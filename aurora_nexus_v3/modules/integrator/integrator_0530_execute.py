...
class Integrator0530Execute:
    """
    Execution handler for Integrator Module 53 - Robotics Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "robotics-integrator"]
...
def execute(
    ...
    handler = Integrator0530Execute(payload, context)
