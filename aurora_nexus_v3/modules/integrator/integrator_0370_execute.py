...
class Integrator0370Execute:
    """
    Execution handler for Integrator Module 37 - Government Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "government-integrator"]
...
def execute(
    ...
    handler = Integrator0370Execute(payload, context)
