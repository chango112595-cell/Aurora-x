...
class Integrator0310Execute:
    """
    Execution handler for Integrator Module 31 - POS Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "pos-integrator"]
...
def execute(
    ...
    handler = Integrator0310Execute(payload, context)
