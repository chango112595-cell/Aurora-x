...
class Integrator0300Execute:
    """
    Execution handler for Integrator Module 30 - WMS Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ['integration', 'orchestration', 'coordination', 'wms-integrator']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Integrator0300Execute(payload, context)
