...
class Integrator0400Execute:
    """
    Execution handler for Integrator Module 40 - Automotive Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "automotive-integrator"]
...
def execute(
    ...
    handler = Integrator0400Execute(payload, context)
