...
class Integrator0410Execute:
    """
    Execution handler for Integrator Module 41 - Manufacturing Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "manufacturing-integrator"]
...
def execute(
    ...
    handler = Integrator0410Execute(payload, context)
