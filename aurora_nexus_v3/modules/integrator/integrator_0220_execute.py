...
class Integrator0220Execute:
    """
    Execution handler for Integrator Module 22 - Web Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "web-integrator"]
...
def execute(
    ...
    handler = Integrator0220Execute(payload, context)
