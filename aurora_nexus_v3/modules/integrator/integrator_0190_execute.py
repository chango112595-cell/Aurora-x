...
class Integrator0190Execute:
    """
    Execution handler for Integrator Module 19 - IoT Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "iot-integrator"]
...
def execute(
    ...
    handler = Integrator0190Execute(payload, context)
