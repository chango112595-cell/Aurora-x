...
class Integrator0390Execute:
    """
    Execution handler for Integrator Module 39 - Aerospace Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "aerospace-integrator"]
...
def execute(
    ...
    handler = Integrator0390Execute(payload, context)
