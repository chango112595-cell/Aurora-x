...
class Integrator0320Execute:
    """
    Execution handler for Integrator Module 32 - Payment Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "payment-integrator"]
...
def execute(
    ...
    handler = Integrator0320Execute(payload, context)
