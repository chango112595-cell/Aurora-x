...
class Integrator0430Execute:
    """
    Execution handler for Integrator Module 43 - E-commerce Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "e-commerce-integrator"]
...
def execute(
    ...
    handler = Integrator0430Execute(payload, context)
