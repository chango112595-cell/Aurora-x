...
class Integrator0240Execute:
    """
    Execution handler for Integrator Module 24 - SCADA Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "scada-integrator"]
...
def execute(
    ...
    handler = Integrator0240Execute(payload, context)
