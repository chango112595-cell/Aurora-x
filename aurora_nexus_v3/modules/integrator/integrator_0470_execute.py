...
class Integrator0470Execute:
    """
    Execution handler for Integrator Module 47 - BI Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "bi-integrator"]
...
def execute(
    ...
    handler = Integrator0470Execute(payload, context)
