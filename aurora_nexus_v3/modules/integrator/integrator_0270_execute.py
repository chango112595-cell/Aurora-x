...
class Integrator0270Execute:
    """
    Execution handler for Integrator Module 27 - CRM Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "crm-integrator"]
...
def execute(
    ...
    handler = Integrator0270Execute(payload, context)
