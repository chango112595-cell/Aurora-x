...
class Integrator0250Execute:
    """
    Execution handler for Integrator Module 25 - PLC Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "plc-integrator"]
...
def execute(
    ...
    handler = Integrator0250Execute(payload, context)
