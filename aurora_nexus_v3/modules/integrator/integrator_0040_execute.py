...
class Integrator0040Execute:
    """
    Execution handler for Integrator Module 4 - Data Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ['integration', 'orchestration', 'coordination', 'data-integrator']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Integrator0040Execute(payload, context)
