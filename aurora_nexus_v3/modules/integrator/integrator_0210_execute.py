...
class Integrator0210Execute:
    """
    Execution handler for Integrator Module 21 - Desktop Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "desktop-integrator"]
...
def execute(
    ...
    handler = Integrator0210Execute(payload, context)
