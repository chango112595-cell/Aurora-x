...
class Integrator0230Execute:
    """
    Execution handler for Integrator Module 23 - Embedded Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "embedded-integrator"]
...
def execute(
    ...
    handler = Integrator0230Execute(payload, context)
