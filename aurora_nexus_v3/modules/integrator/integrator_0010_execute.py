...
class Integrator0010Execute:
    """
    Execution handler for Integrator Module 1 - System Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "system-integrator"]
...
def execute(
    ...
    handler = Integrator0010Execute(payload, context)
