...
class Integrator0380Execute:
    """
    Execution handler for Integrator Module 38 - Defense Integrator.
    Category: integrator
    Sandbox: restricted
    """
    ...
    TAGS = ["integration", "orchestration", "coordination", "defense-integrator"]
...
def execute(
    ...
    handler = Integrator0380Execute(payload, context)
