...
class Validator0086Execute:
    """
    Execution handler for Validator Module 9 - Request Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['validation', 'verification', 'compliance', 'request-validator']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Validator0086Execute(payload, context)
