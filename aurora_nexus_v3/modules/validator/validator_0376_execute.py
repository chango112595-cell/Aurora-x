...
class Validator0376Execute:
    """
    Execution handler for Validator Module 38 - Business Rule Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "business-rule-validator"]
...
def execute(
    ...
    handler = Validator0376Execute(payload, context)
