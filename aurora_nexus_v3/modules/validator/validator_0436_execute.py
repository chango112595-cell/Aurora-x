...
class Validator0436Execute:
    """
    Execution handler for Validator Module 44 - Existence Checker.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "existence-checker"]
...
def execute(
    ...
    handler = Validator0436Execute(payload, context)
