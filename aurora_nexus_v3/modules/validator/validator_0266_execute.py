...
class Validator0266Execute:
    """
    Execution handler for Validator Module 27 - SAML Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "saml-validator"]
...
def execute(
    ...
    handler = Validator0266Execute(payload, context)
