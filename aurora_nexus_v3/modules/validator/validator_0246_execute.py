...
class Validator0246Execute:
    """
    Execution handler for Validator Module 25 - JWT Verifier.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "jwt-verifier"]
...
def execute(
    ...
    handler = Validator0246Execute(payload, context)
