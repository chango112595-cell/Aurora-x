...
class Validator0116Execute:
    """
    Execution handler for Validator Module 12 - Output Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['validation', 'verification', 'compliance', 'output-validator']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Validator0116Execute(payload, context)
