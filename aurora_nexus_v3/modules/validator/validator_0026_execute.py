...
class Validator0026Execute:
    """
    Execution handler for Validator Module 3 - XML Schema.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "xml-schema"]
...
def execute(
    ...
    handler = Validator0026Execute(payload, context)
