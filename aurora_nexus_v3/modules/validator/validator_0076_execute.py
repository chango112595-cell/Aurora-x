...
class Validator0076Execute:
    """
    Execution handler for Validator Module 8 - API Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "api-validator"]
...
def execute(
    ...
    handler = Validator0076Execute(payload, context)
