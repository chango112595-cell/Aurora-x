...
class Validator0126Execute:
    """
    Execution handler for Validator Module 13 - Form Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "form-validator"]
...
def execute(
    ...
    handler = Validator0126Execute(payload, context)
