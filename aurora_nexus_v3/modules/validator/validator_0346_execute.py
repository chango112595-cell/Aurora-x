...
class Validator0346Execute:
    """
    Execution handler for Validator Module 35 - Range Checker.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['validation', 'verification', 'compliance', 'range-checker']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Validator0346Execute(payload, context)
