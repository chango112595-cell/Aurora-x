...
class Validator0366Execute:
    """
    Execution handler for Validator Module 37 - Constraint Checker.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "constraint-checker"]
...
def execute(
    ...
    handler = Validator0366Execute(payload, context)
