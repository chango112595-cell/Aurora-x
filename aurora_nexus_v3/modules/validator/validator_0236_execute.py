...
class Validator0236Execute:
    """
    Execution handler for Validator Module 24 - Token Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "token-validator"]
...
def execute(
    ...
    handler = Validator0236Execute(payload, context)
