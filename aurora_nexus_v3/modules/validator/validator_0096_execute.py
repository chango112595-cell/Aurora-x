...
class Validator0096Execute:
    """
    Execution handler for Validator Module 10 - Response Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "response-validator"]
...
def execute(
    ...
    handler = Validator0096Execute(payload, context)
