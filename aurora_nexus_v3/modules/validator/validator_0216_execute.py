...
class Validator0216Execute:
    """
    Execution handler for Validator Module 22 - Signature Verifier.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "signature-verifier"]
...
def execute(
    ...
    handler = Validator0216Execute(payload, context)
