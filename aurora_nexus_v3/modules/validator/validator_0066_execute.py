...
class Validator0066Execute:
    """
    Execution handler for Validator Module 7 - Contract Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "contract-validator"]
...
def execute(
    ...
    handler = Validator0066Execute(payload, context)
