...
class Validator0306Execute:
    """
    Execution handler for Validator Module 31 - Policy Enforcer.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "policy-enforcer"]
...
def execute(
    ...
    handler = Validator0306Execute(payload, context)
