...
class Validator0446Execute:
    """
    Execution handler for Validator Module 45 - Consistency Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "consistency-validator"]
...
def execute(
    ...
    handler = Validator0446Execute(payload, context)
