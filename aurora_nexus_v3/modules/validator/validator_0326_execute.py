...
class Validator0326Execute:
    """
    Execution handler for Validator Module 33 - Rate Limit Checker.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['validation', 'verification', 'compliance', 'rate-limit-checker']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Validator0326Execute(payload, context)
