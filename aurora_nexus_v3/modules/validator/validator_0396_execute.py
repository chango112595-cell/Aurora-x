...
class Validator0396Execute:
    """
    Execution handler for Validator Module 40 - Entity Validator.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["validation", "verification", "compliance", "entity-validator"]
...
def execute(
    ...
    handler = Validator0396Execute(payload, context)
