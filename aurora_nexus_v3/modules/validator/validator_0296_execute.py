...
class Validator0296Execute:
    """
    Execution handler for Validator Module 30 - RBAC Verifier.
    Category: validator
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['validation', 'verification', 'compliance', 'rbac-verifier']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Validator0296Execute(payload, context)
