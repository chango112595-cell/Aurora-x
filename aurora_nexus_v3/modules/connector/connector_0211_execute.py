"""
Aurora-X Module: M0211 - Connector Module 22 - LDAP Directory
Category: connector
...
class Connector0211Execute:
    """
    Execution handler for Connector Module 22 - LDAP Directory.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'ldap-directory']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0211Execute(payload, context)
