"""
Aurora-X Module: M0481 - Connector Module 49 - Mailchimp Sync
Category: connector
...
class Connector0481Execute:
    """
    Execution handler for Connector Module 49 - Mailchimp Sync.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'mailchimp-sync']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0481Execute(payload, context)
