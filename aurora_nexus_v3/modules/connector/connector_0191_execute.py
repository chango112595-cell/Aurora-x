"""
Aurora-X Module: M0191 - Connector Module 20 - GCS Bucket
Category: connector
...
class Connector0191Execute:
    """
    Execution handler for Connector Module 20 - GCS Bucket.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'gcs-bucket']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0191Execute(payload, context)
