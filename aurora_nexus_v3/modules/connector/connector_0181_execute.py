"""
Aurora-X Module: M0181 - Connector Module 19 - Azure Blob
Category: connector
...
class Connector0181Execute:
    """
    Execution handler for Connector Module 19 - Azure Blob.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "azure-blob"]
...
def execute(
    ...
    handler = Connector0181Execute(payload, context)
