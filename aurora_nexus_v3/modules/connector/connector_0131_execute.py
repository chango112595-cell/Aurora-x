"""
Aurora-X Module: M0131 - Connector Module 14 - UDP Datagram
Category: connector
...
class Connector0131Execute:
    """
    Execution handler for Connector Module 14 - UDP Datagram.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'udp-datagram']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0131Execute(payload, context)
