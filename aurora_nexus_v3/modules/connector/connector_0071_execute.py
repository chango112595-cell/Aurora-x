"""
Aurora-X Module: M0071 - Connector Module 8 - gRPC Channel
Category: connector
...
class Connector0071Execute:
    """
    Execution handler for Connector Module 8 - gRPC Channel.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'grpc-channel']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0071Execute(payload, context)
