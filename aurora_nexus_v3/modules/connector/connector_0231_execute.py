"""
Aurora-X Module: M0231 - Connector Module 24 - JWT Handler
Category: connector
...
class Connector0231Execute:
    """
    Execution handler for Connector Module 24 - JWT Handler.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'jwt-handler']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0231Execute(payload, context)
