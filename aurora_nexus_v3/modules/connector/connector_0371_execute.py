"""
Aurora-X Module: M0371 - Connector Module 38 - Bitbucket Link
Category: connector
...
class Connector0371Execute:
    """
    Execution handler for Connector Module 38 - Bitbucket Link.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'bitbucket-link']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0371Execute(payload, context)
