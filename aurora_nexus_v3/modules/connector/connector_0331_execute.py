"""
Aurora-X Module: M0331 - Connector Module 34 - Teams Connector
Category: connector
...
class Connector0331Execute:
    """
    Execution handler for Connector Module 34 - Teams Connector.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "teams-connector"]
...
def execute(
    ...
    handler = Connector0331Execute(payload, context)
