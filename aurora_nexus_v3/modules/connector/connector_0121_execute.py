"""
Aurora-X Module: M0121 - Connector Module 13 - TCP Socket
Category: connector
...
class Connector0121Execute:
    """
    Execution handler for Connector Module 13 - TCP Socket.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'tcp-socket']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0121Execute(payload, context)
