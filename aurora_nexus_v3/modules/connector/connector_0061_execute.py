"""
Aurora-X Module: M0061 - Connector Module 7 - GraphQL Bridge
Category: connector
...
class Connector0061Execute:
    """
    Execution handler for Connector Module 7 - GraphQL Bridge.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'graphql-bridge']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0061Execute(payload, context)
