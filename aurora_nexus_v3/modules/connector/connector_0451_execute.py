"""
Aurora-X Module: M0451 - Connector Module 46 - PayPal Gateway
Category: connector
...
class Connector0451Execute:
    """
    Execution handler for Connector Module 46 - PayPal Gateway.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'paypal-gateway']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0451Execute(payload, context)
