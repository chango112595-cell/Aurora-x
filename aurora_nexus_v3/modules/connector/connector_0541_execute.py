"""
Aurora-X Module: M0541 - Connector Module 55 - MSSQL Link
Category: connector
...
class Connector0541Execute:
    """
    Execution handler for Connector Module 55 - MSSQL Link.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'mssql-link']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0541Execute(payload, context)
