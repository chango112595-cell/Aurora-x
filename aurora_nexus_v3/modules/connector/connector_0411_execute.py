"""
Aurora-X Module: M0411 - Connector Module 42 - HubSpot Link
Category: connector
...
class Connector0411Execute:
    """
    Execution handler for Connector Module 42 - HubSpot Link.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'hubspot-link']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0411Execute(payload, context)
