"""
Aurora-X Module: M0091 - Connector Module 10 - Redis Link
Category: connector
...
class Connector0091Execute:
    """
    Execution handler for Connector Module 10 - Redis Link.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "redis-link"]
...
def execute(
    ...
    handler = Connector0091Execute(payload, context)
