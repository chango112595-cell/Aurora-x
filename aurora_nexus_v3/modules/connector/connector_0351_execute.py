"""
Aurora-X Module: M0351 - Connector Module 36 - GitHub Sync
Category: connector
...
class Connector0351Execute:
    """
    Execution handler for Connector Module 36 - GitHub Sync.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "github-sync"]
...
def execute(
    ...
    handler = Connector0351Execute(payload, context)
