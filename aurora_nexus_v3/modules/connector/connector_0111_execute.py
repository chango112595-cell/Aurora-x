"""
Aurora-X Module: M0111 - Connector Module 12 - RabbitMQ Relay
Category: connector
...
class Connector0111Execute:
    """
    Execution handler for Connector Module 12 - RabbitMQ Relay.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "rabbitmq-relay"]
...
def execute(
    ...
    handler = Connector0111Execute(payload, context)
