"""
Aurora-X Module: M0201 - Connector Module 21 - OAuth Provider
Category: connector
...
class Connector0201Execute:
    """
    Execution handler for Connector Module 21 - OAuth Provider.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "oauth-provider"]
...
def execute(
    ...
    handler = Connector0201Execute(payload, context)
