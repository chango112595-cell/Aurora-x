"""
Aurora-X Module: M0431 - Connector Module 44 - Intercom Chat
Category: connector
...
class Connector0431Execute:
    """
    Execution handler for Connector Module 44 - Intercom Chat.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'intercom-chat']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0431Execute(payload, context)
