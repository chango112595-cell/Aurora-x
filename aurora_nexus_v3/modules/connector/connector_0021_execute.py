"""
Aurora-X Module: M0021 - Connector Module 3 - Message Queue
Category: connector
...
class Connector0021Execute:
    """
    Execution handler for Connector Module 3 - Message Queue.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "message-queue"]
...
def execute(
    ...
    handler = Connector0021Execute(payload, context)
