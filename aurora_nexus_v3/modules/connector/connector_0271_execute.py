"""
Aurora-X Module: M0271 - Connector Module 28 - Push Notifier
Category: connector
...
class Connector0271Execute:
    """
    Execution handler for Connector Module 28 - Push Notifier.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'push-notifier']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0271Execute(payload, context)
