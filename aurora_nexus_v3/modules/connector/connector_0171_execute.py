"""
Aurora-X Module: M0171 - Connector Module 18 - S3 Storage
Category: connector
...
class Connector0171Execute:
    """
    Execution handler for Connector Module 18 - S3 Storage.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "s3-storage"]
...
def execute(
    ...
    handler = Connector0171Execute(payload, context)
