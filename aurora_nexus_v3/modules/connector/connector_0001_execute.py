"""
Aurora-X Module: M0001 - Connector Module 1 - Database Bridge
Category: connector
...
class Connector0001Execute:
    """
    Execution handler for Connector Module 1 - Database Bridge.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "database-bridge"]
...
def execute(
    ...
    handler = Connector0001Execute(payload, context)
