"""
Aurora-X Module: M0311 - Connector Module 32 - Discord Bot
Category: connector
...
class Connector0311Execute:
    """
    Execution handler for Connector Module 32 - Discord Bot.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'discord-bot']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0311Execute(payload, context)
