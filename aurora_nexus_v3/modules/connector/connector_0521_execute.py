"""
Aurora-X Module: M0521 - Connector Module 53 - MySQL Cluster
Category: connector
...
class Connector0521Execute:
    """
    Execution handler for Connector Module 53 - MySQL Cluster.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "mysql-cluster"]
...
def execute(
    ...
    handler = Connector0521Execute(payload, context)
