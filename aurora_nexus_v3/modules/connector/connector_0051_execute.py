"""
Aurora-X Module: M0051 - Connector Module 6 - REST Endpoint
Category: connector
...
class Connector0051Execute:
    """
    Execution handler for Connector Module 6 - REST Endpoint.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'rest-endpoint']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0051Execute(payload, context)
