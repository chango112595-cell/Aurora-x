"""
Aurora-X Module: M0141 - Connector Module 15 - HTTP Client
Category: connector
...
class Connector0141Execute:
    """
    Execution handler for Connector Module 15 - HTTP Client.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "http-client"]
...
def execute(
    ...
    handler = Connector0141Execute(payload, context)
