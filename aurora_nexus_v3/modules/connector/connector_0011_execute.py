"""
Aurora-X Module: M0011 - Connector Module 2 - API Gateway
Category: connector
...
class Connector0011Execute:
    """
    Execution handler for Connector Module 2 - API Gateway.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'api-gateway']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0011Execute(payload, context)
