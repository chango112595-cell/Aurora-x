"""
Aurora-X Module: M0421 - Connector Module 43 - Zendesk Support
Category: connector
...
class Connector0421Execute:
    """
    Execution handler for Connector Module 43 - Zendesk Support.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'zendesk-support']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0421Execute(payload, context)
