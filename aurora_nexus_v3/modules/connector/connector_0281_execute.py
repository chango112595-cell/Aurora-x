"""
Aurora-X Module: M0281 - Connector Module 29 - Email Gateway
Category: connector
...
class Connector0281Execute:
    """
    Execution handler for Connector Module 29 - Email Gateway.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "email-gateway"]
...
def execute(
    ...
    handler = Connector0281Execute(payload, context)
