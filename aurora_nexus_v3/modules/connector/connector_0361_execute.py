"""
Aurora-X Module: M0361 - Connector Module 37 - GitLab Bridge
Category: connector
...
class Connector0361Execute:
    """
    Execution handler for Connector Module 37 - GitLab Bridge.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'gitlab-bridge']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0361Execute(payload, context)
