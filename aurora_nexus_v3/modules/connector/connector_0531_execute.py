"""
Aurora-X Module: M0531 - Connector Module 54 - Oracle Bridge
Category: connector
...
class Connector0531Execute:
    """
    Execution handler for Connector Module 54 - Oracle Bridge.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "oracle-bridge"]
...
def execute(
    ...
    handler = Connector0531Execute(payload, context)
