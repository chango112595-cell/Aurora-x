"""
Aurora-X Module: M0241 - Connector Module 25 - SSO Bridge
Category: connector
...
class Connector0241Execute:
    """
    Execution handler for Connector Module 25 - SSO Bridge.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "sso-bridge"]
...
def execute(
    ...
    handler = Connector0241Execute(payload, context)
