"""
Aurora-X Module: M0501 - Connector Module 51 - MongoDB Atlas
Category: connector
...
class Connector0501Execute:
    """
    Execution handler for Connector Module 51 - MongoDB Atlas.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "mongodb-atlas"]
...
def execute(
    ...
    handler = Connector0501Execute(payload, context)
