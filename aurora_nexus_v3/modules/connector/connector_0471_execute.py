"""
Aurora-X Module: M0471 - Connector Module 48 - SendGrid Mail
Category: connector
...
class Connector0471Execute:
    """
    Execution handler for Connector Module 48 - SendGrid Mail.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "sendgrid-mail"]
...
def execute(
    ...
    handler = Connector0471Execute(payload, context)
