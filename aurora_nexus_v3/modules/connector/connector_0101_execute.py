"""
Aurora-X Module: M0101 - Connector Module 11 - Kafka Pipe
Category: connector
...
class Connector0101Execute:
    """
    Execution handler for Connector Module 11 - Kafka Pipe.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "kafka-pipe"]
...
def execute(
    ...
    handler = Connector0101Execute(payload, context)
