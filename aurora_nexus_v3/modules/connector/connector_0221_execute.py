"""
Aurora-X Module: M0221 - Connector Module 23 - SAML Identity
Category: connector
...
class Connector0221Execute:
    """
    Execution handler for Connector Module 23 - SAML Identity.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'saml-identity']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0221Execute(payload, context)
