"""
Aurora-X Module: M0341 - Connector Module 35 - Zoom API
Category: connector
...
class Connector0341Execute:
    """
    Execution handler for Connector Module 35 - Zoom API.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "zoom-api"]
...
def execute(
    ...
    handler = Connector0341Execute(payload, context)
