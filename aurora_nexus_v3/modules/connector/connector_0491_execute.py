"""
Aurora-X Module: M0491 - Connector Module 50 - Elasticsearch
Category: connector
...
class Connector0491Execute:
    """
    Execution handler for Connector Module 50 - Elasticsearch.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "elasticsearch"]
...
def execute(
    ...
    handler = Connector0491Execute(payload, context)
