"""
Aurora-X Module: M0441 - Connector Module 45 - Stripe Payment
Category: connector
...
class Connector0441Execute:
    """
    Execution handler for Connector Module 45 - Stripe Payment.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "stripe-payment"]
...
def execute(
    ...
    handler = Connector0441Execute(payload, context)
