"""
Aurora-X Module: M0081 - Connector Module 9 - MQTT Broker
Category: connector
...
class Connector0081Execute:
    """
    Execution handler for Connector Module 9 - MQTT Broker.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'mqtt-broker']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0081Execute(payload, context)
