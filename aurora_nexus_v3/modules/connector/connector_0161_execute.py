"""
Aurora-X Module: M0161 - Connector Module 17 - SFTP Secure
Category: connector
...
class Connector0161Execute:
    """
    Execution handler for Connector Module 17 - SFTP Secure.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "sftp-secure"]
...
def execute(
    ...
    handler = Connector0161Execute(payload, context)
