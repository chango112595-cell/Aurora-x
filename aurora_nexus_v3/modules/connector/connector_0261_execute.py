"""
Aurora-X Module: M0261 - Connector Module 27 - Polling Agent
Category: connector
...
class Connector0261Execute:
    """
    Execution handler for Connector Module 27 - Polling Agent.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "polling-agent"]
...
def execute(
    ...
    handler = Connector0261Execute(payload, context)
