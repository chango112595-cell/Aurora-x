"""
Aurora-X Module: M0381 - Connector Module 39 - Jira Connector
Category: connector
...
class Connector0381Execute:
    """
    Execution handler for Connector Module 39 - Jira Connector.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'jira-connector']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0381Execute(payload, context)
