"""
Aurora-X Module: M0151 - Connector Module 16 - FTP Transfer
Category: connector
...
class Connector0151Execute:
    """
    Execution handler for Connector Module 16 - FTP Transfer.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ["connectivity", "integration", "data-flow", "ftp-transfer"]
...
def execute(
    ...
    handler = Connector0151Execute(payload, context)
