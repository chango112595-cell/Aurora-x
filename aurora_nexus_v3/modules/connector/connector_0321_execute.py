"""
Aurora-X Module: M0321 - Connector Module 33 - Telegram Link
Category: connector
...
class Connector0321Execute:
    """
    Execution handler for Connector Module 33 - Telegram Link.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'telegram-link']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0321Execute(payload, context)
