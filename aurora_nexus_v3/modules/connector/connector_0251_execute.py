"""
Aurora-X Module: M0251 - Connector Module 26 - Webhook Receiver
Category: connector
...
class Connector0251Execute:
    """
    Execution handler for Connector Module 26 - Webhook Receiver.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'webhook-receiver']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0251Execute(payload, context)
