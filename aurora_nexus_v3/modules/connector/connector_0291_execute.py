"""
Aurora-X Module: M0291 - Connector Module 30 - SMS Relay
Category: connector
...
class Connector0291Execute:
    """
    Execution handler for Connector Module 30 - SMS Relay.
    Category: connector
    Sandbox: vm
    """
    ...
    SANDBOX_TYPE = "vm"
    TAGS = ['connectivity', 'integration', 'data-flow', 'sms-relay']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Connector0291Execute(payload, context)
