...
def detect_cuda_details(logger: logging.Logger | None = None) -> dict[str, Any]:
...
class HardwareDetector:
    ...
    CAPABILITY_THRESHOLDS: dict[str, int] = {"full": 80, "standard": 50, "lite": 25, "micro": 0}
    ...
    async def initialize(self) -> None:
        ...
        self.logger.info(
            f"Hardware detected: {self.profile.cpu.cores_logical} cores, "
        ...
        try:
            ...
            for name, addr_list in addrs.items():
                ...
                for addr in addr_list:
                    ...
                    if family in (socket.AF_INET, socket.AF_INET6) or family_name in (
                        "AF_INET",
                        "AF_INET6",
                    ):
    ...
    def _detect_battery(self) -> tuple[bool, float | None]:
        try:
            import psutil
    ...
    async def get_info(self) -> dict[str, Any]:
        ...
        return {
            ...
            "network": [
                {"name": n.name, "address": n.address, "is_up": n.is_up} for n in profile.network
            ],
            "gpu_available": profile.gpu_available,
            "gpu_details": profile.gpu_details,
            "battery": {"powered": profile.battery_powered, "percent": profile.battery_percent},
