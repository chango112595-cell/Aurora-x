"""
Aurora-X Module: M0425 - Transformer Module 43 - Code Highlighter
...
class Transformer0425Execute:
    """
    Execution handler for Transformer Module 43 - Code Highlighter.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "code-highlighter"]
...
def execute(
    ...
    handler = Transformer0425Execute(payload, context)
