"""
Aurora-X Module: M0115 - Transformer Module 12 - URL Encoder
...
class Transformer0115Execute:
    """
    Execution handler for Transformer Module 12 - URL Encoder.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "url-encoder"]
...
def execute(
    ...
    handler = Transformer0115Execute(payload, context)
