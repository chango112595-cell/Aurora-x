...
class Transformer0095Execute:
    """
    Execution handler for Transformer Module 10 - BSON Converter.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "bson-converter"]
...
def execute(
    ...
    handler = Transformer0095Execute(payload, context)
