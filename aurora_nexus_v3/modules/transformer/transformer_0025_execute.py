"""
Aurora-X Module: M0025 - Transformer Module 3 - CSV Parser
...
class Transformer0025Execute:
    """
    Execution handler for Transformer Module 3 - CSV Parser.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "csv-parser"]
...
def execute(
    ...
    handler = Transformer0025Execute(payload, context)
