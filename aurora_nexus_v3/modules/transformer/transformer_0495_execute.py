"""
Aurora-X Module: M0495 - Transformer Module 50 - JMESPath Engine
...
class Transformer0495Execute:
    """
    Execution handler for Transformer Module 50 - JMESPath Engine.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "jmespath-engine"]
...
def execute(
    ...
    handler = Transformer0495Execute(payload, context)
