"""
Aurora-X Module: M0205 - Transformer Module 21 - Date Formatter
...
class Transformer0205Execute:
    """
    Execution handler for Transformer Module 21 - Date Formatter.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "date-formatter"]
...
def execute(
    ...
    handler = Transformer0205Execute(payload, context)
