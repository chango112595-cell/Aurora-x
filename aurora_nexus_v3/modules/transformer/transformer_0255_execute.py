"""
Aurora-X Module: M0255 - Transformer Module 26 - Unit Converter
...
class Transformer0255Execute:
    """
    Execution handler for Transformer Module 26 - Unit Converter.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ['transformation', 'conversion', 'encoding', 'unit-converter']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Transformer0255Execute(payload, context)
