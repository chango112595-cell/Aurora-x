"""
Aurora-X Module: M0305 - Transformer Module 31 - Image Resizer
...
class Transformer0305Execute:
    """
    Execution handler for Transformer Module 31 - Image Resizer.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ['transformation', 'conversion', 'encoding', 'image-resizer']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Transformer0305Execute(payload, context)
