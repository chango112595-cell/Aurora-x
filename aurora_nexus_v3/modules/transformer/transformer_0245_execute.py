"""
Aurora-X Module: M0245 - Transformer Module 25 - Locale Handler
...
class Transformer0245Execute:
    """
    Execution handler for Transformer Module 25 - Locale Handler.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "locale-handler"]
...
def execute(
    ...
    handler = Transformer0245Execute(payload, context)
