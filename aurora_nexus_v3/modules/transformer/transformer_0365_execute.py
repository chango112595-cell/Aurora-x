"""
Aurora-X Module: M0365 - Transformer Module 37 - Charset Converter
...
class Transformer0365Execute:
    """
    Execution handler for Transformer Module 37 - Charset Converter.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "charset-converter"]
...
def execute(
    ...
    handler = Transformer0365Execute(payload, context)
