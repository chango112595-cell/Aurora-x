"""
Aurora-X Module: M0265 - Transformer Module 27 - Measurement Transform
...
class Transformer0265Execute:
    """
    Execution handler for Transformer Module 27 - Measurement Transform.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "measurement-transform"]
...
def execute(
    ...
    handler = Transformer0265Execute(payload, context)
