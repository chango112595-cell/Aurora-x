"""
Aurora-X Module: M0215 - Transformer Module 22 - Timezone Converter
...
class Transformer0215Execute:
    """
    Execution handler for Transformer Module 22 - Timezone Converter.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "timezone-converter"]
...
def execute(
    ...
    handler = Transformer0215Execute(payload, context)
