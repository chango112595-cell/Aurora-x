"""
Aurora-X Module: M0015 - Transformer Module 2 - XML Converter
...
class Transformer0015Execute:
    """
    Execution handler for Transformer Module 2 - XML Converter.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "xml-converter"]
...
def execute(
    ...
    handler = Transformer0015Execute(payload, context)
