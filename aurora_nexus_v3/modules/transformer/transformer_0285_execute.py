"""
Aurora-X Module: M0285 - Transformer Module 29 - Coordinate Transform
...
class Transformer0285Execute:
    """
    Execution handler for Transformer Module 29 - Coordinate Transform.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "coordinate-transform"]
...
def execute(
    ...
    handler = Transformer0285Execute(payload, context)
