"""
Aurora-X Module: M0125 - Transformer Module 13 - HTML Encoder
...
class Transformer0125Execute:
    """
    Execution handler for Transformer Module 13 - HTML Encoder.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "html-encoder"]
...
def execute(
    ...
    handler = Transformer0125Execute(payload, context)
