"""
Aurora-X Module: M0525 - Transformer Module 53 - Query Transformer
...
class Transformer0525Execute:
    """
    Execution handler for Transformer Module 53 - Query Transformer.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "query-transformer"]
...
def execute(
    ...
    handler = Transformer0525Execute(payload, context)
