"""
Aurora-X Module: M0225 - Transformer Module 23 - Currency Formatter
...
class Transformer0225Execute:
    """
    Execution handler for Transformer Module 23 - Currency Formatter.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "currency-formatter"]
...
def execute(
    ...
    handler = Transformer0225Execute(payload, context)
