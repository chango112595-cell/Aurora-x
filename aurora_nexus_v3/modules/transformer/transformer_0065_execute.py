"""
Aurora-X Module: M0065 - Transformer Module 7 - Avro Serializer
...
class Transformer0065Execute:
    """
    Execution handler for Transformer Module 7 - Avro Serializer.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "avro-serializer"]
...
def execute(
    ...
    handler = Transformer0065Execute(payload, context)
