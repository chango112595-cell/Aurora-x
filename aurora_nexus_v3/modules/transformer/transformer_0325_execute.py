"""
Aurora-X Module: M0325 - Transformer Module 33 - Compression Handler
...
class Transformer0325Execute:
    """
    Execution handler for Transformer Module 33 - Compression Handler.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "compression-handler"]
...
def execute(
    ...
    handler = Transformer0325Execute(payload, context)
