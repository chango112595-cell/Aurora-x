"""
Aurora-X Module: M0035 - Transformer Module 4 - YAML Processor
...
class Transformer0035Execute:
    """
    Execution handler for Transformer Module 4 - YAML Processor.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ["transformation", "conversion", "encoding", "yaml-processor"]
...
def execute(
    ...
    handler = Transformer0035Execute(payload, context)
