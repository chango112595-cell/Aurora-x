"""
Aurora-X Module: M0105 - Transformer Module 11 - Base64 Encoder
...
class Transformer0105Execute:
    """
    Execution handler for Transformer Module 11 - Base64 Encoder.
    Category: transformer
    Sandbox: restricted
    """
    ...
    TAGS = ['transformation', 'conversion', 'encoding', 'base64-encoder']
...
def execute(payload: Any = None, context: Optional[Dict[str, Any]] = None,
    ...
    handler = Transformer0105Execute(payload, context)
