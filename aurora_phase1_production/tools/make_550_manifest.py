...
CATEGORIES = [
    "connector", "processor", "analyzer", "validator", "transformer",
    "optimizer", "monitor", "generator", "formatter", "integrator"
]
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate Aurora module manifest"
    )
    parser.add_argument(
        "--out", "-o",
        type=str,
        default="modules.manifest.json",
