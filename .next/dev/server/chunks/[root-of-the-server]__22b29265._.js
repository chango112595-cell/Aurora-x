...
"[project]/server/aurora-chat.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
function setupAuroraChatWebSocket(server) {
    const wss = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ws$2f$lib$2f$websocket$2d$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__WebSocketServer$3e$__["WebSocketServer"]({
        server,
        path: '/aurora/chat'
    });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$aurora$2d$chat$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/aurora-chat.ts [app-route] (ecmascript)");
;
;
async function POST(request) {
    ...
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$aurora$2d$chat$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getChatResponse"])(message, sessionId);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: true,
        response,
        message: response,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__22b29265._.js.map