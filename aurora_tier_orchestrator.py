...
class AuroraTierOrchestrator:
    ...
    def learn_from_execution(self, result: Dict):
        ...
        if result['success']:
            self.success_patterns[tier_combo_key] = self.success_patterns.get(
                tier_combo_key, 0) + 1
    ...
    def _save_learning(self):
        ...
        learning_file = Path('.aurora_knowledge') / \
            'tier_orchestration_learning.json'
...
def main():
    ...
    print(f"\n{'='*60}")
    synthesis = orchestrator.synthesize_knowledge(
