...
class AuroraHTMLChecker:
    ...
    def scan_for_html(self):
        ...
        skip_dirs = {'node_modules', 'venv', '.venv', 'dist', 'build', '__pycache__', '.git', 'backups'}
        ...
        for html_info in self.html_files:
            ...
            try:
                ...
                if needs_conversion:
                    ...
                    suggested_location = self.suggest_tsx_location(purpose, tsx_name)
                ...
                if needs_conversion:
                    print(f"     → Suggested TSX: {conversion_info.get('suggested_tsx', 'N/A')}")
    ...
    def generate_conversion_plan(self):
        ...
        if not files_to_convert:
            ...
            print(f"\n💡 RECOMMENDATION:")
            print(f"   Convert {len(files_to_convert)} HTML files to modern TSX components")
