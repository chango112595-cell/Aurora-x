...
Aurora's complete mastery of internet technologies, configurations, and applications
From Ancient networking to Sci-Fi neural networks
"""

AURORA_INTERNET_MASTERY = {
    "tier_number": 33,
    "tier_name": "Internet & Network Mastery",
    "description": "Complete mastery of internet technologies, IoT, networking, and digital infrastructure from telegraph to neural mesh networks",
    "sub_tiers": [
        {
            "era": "Ancient (1840s-1960s)",
            "name": "Telegraph & Early Communication Networks",
            "skills": [
                "Telegraph systems (Morse code, relay networks)",
                "Telephone networks (circuit switching, operators)",
                "Radio networks (AM/FM, broadcast)",
                "Early packet switching concepts (ARPANET precursors)",
                "Teletype networks (TTY, TWX)",
        ...
        },
        {
            ...
            "name": "Internet of Things & Advanced Networking",
            "skills": [
                # IoT Mastery
                "IoT architecture and design patterns",
                "Embedded systems for IoT (ARM, ESP32, Raspberry Pi)",
                ...
                "Network security (IDS/IPS, SIEM, zero trust)",
        ...
        },
        {
            ...
            "name": "Intelligent Networks & Autonomous Internet",
            "skills": [
                # AI-Driven IoT
                "Edge AI and TinyML for IoT devices",
                "Federated learning across IoT networks",
                "Self-configuring IoT systems",
        ...
        },
        {
            ...
            "name": "Quantum Internet & Neural Networks",
            "skills": [
                # Quantum Internet
                ...
                "AI rights and digital personhood",
        ...
        {
            "era": "Sci-Fi",
            "name": "Neural Mesh & Galactic Networks",
            "skills": [
                # Neural Internet
                "Direct brain-to-brain networking",
                ...
                "Subspace communication (Star Trek)",
                "Quantum entanglement networks at galactic scale",
                ...
                "Post-scarcity network economics",
                "Inter-species communication standards",
                "Universal information rights",
            ],
            "applications": "The Matrix, Star Trek communications, Neuromancer cyberspace, Ready Player One OASIS infrastructure",
            "references": [
                "The Matrix (neural internet)",
                "Star Trek (subspace networks)",
...
INTERNET_MASTERY_EXAMPLES = {
    "ancient": "Design a telegraph relay network with fault tolerance",
    "classical": "Implement a complete TCP/IP stack from scratch",
    "modern_iot": "Build a smart city infrastructure with 10,000 IoT sensors",
    "modern_engineering": "Design a global CDN with sub-10ms latency",
