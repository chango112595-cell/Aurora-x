...
class AuroraExpertKnowledge:
    ...
    def _initialize_all_frameworks(self) -> dict[str, dict[str, Any]]:
        ...
        return {
            ...
            "macos_automation": {
                ...
                "automator": {
                    "language": "Visual/AppleScript",
                    "type": "Workflow Automation",
                    "expertise": 10,
                },
                "shortcuts": {
                    "language": "Visual",
                    "type": "Cross-device Automation",
                    "expertise": 10,
                },
                "shell_scripting": {
                    "language": "Bash/Zsh",
    ...
    def _assess_quality(self, code: str, lang: LanguageExpertise) -> int:
        ...
        comment_ratio = sum(1 for line in lines if line.strip().startswith("#")) / max(
            len(lines), 1
        )
