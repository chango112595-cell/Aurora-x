...
new_tiers = [
    ("43", "Visual Code Understanding",
     "Screenshot analysis, UI mockups, visual debugging"),
    ("44", "Live System Integration",
     "Real-time API/DB connections, Docker, WebSocket"),
    ...
    ("48", "Multi-Agent Coordination",
     "Agent spawning, parallel execution, orchestration"),
