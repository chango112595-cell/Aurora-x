...
export default function AuroraFuturisticLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems: NavItem[] = [
    ...
    { path: '/tiers', label: '188 Intelligence Tiers', icon: <Network className="w-5 h-5" />, category: 'intelligence' },
              ...
              {sidebarOpen && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-purple-400">188 Tiers • 66 Programs • 200+ Modules</p>
                  </div>
                </div>
              )}
              <button
