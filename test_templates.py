...
def test_cli_hash_files():
    ...
    print(f"✓ Generated CLI tool saved to test_cli_hash.py")
...
def test_cli_generic():
    ...
    print(f"✓ Generated generic CLI tool saved to test_cli_generic.py")
    print(f"  Lines of code: {len(code.splitlines())}")
...
def test_lib_factorial():
    ...
    print(f"✓ Generated factorial function saved to test_lib_factorial.py")
    print(f"  Lines of code: {len(code.splitlines())}")
...
def test_lib_generic():
    ...
    print(f"✓ Generated generic function saved to test_lib_generic.py")
    print(f"  Lines of code: {len(code.splitlines())}")
