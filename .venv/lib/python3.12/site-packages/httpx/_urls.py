...
class URL:
    """
    url = httpx.URL("HTTPS://jo%40email.com:a%20secret@mller.de:1234/pa%20th?search=ab#anchorlink")

    assert url.scheme == "https"
    assert url.username == "jo@email.com"
    assert url.password == "a secret"
    assert url.userinfo == b"jo%40email.com:a%20secret"
    assert url.host == "mller.de"
    ...
    The components of a URL are broken down like this:
       ...
       https://jo%40email.com:a%20secret@mller.de:1234/pa%20th?search=ab#anchorlink
