...
def _body_framing(request_method: bytes, event: Request | Response) -> tuple[str, tuple[()] | tuple[int]]:
...
class Connection:
    ...
    def _get_io_object(
        ...
        if state is SEND_BODY:
            ...
            framing_type, args = _body_framing(cast(bytes, self._request_method), cast(Request | Response, event))
    ...
    @overload
    def send(self, event: Request | InformationalResponse | Response | Data | EndOfMessage) -> bytes: ...
