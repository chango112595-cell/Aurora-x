...
class ImmutableDictMixin(t.Generic[K, V]):
    ...
    @classmethod
    @t.overload
    def fromkeys(cls, keys: cabc.Iterable[K], value: None) -> ImmutableDictMixin[K, t.Any | None]: ...
    @classmethod
    @t.overload
...
class UpdateDictMixin(dict[K, V]):
    ...
    @_always_update
    def __ior__(self, other: cabc.Mapping[K, V] | cabc.Iterable[tuple[K, V]]) -> te.Self:  # type: ignore[override]
