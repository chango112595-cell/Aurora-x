...
class Parser:
    ...
    def __init__(
        ...
        self.closed = False
        self.extensions: dict[str, t.Callable[[Parser], nodes.Node | list[nodes.Node]]] = {}
    ...
    def _fail_ut_eof(
        ...
        if end_token_stack:
            currently_looking: str | None = " or ".join(map(repr, map(describe_token_expr, end_token_stack[-1])))
        else:
    ...
    def parse_statements(self, end_tokens: tuple[str, ...], drop_needle: bool = False) -> list[nodes.Node]:
