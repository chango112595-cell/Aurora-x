...
class Environment:
    ...
    @internalcode
    def _load_template(self, name: str, globals: t.MutableMapping[str, t.Any] | None) -> "Template":
...
class Template:
    ...
    async def _get_default_module_async(self, ctx: Context | None = None) -> "TemplateModule":
        if ctx is not None:
            keys = ctx.globals_keys - self.globals.keys()
