...
@pass_context
def _gettext_alias(__context: Context, *args: t.Any, **kwargs: t.Any) -> t.Any | Undefined:
...
class InternationalizationExtension(Extension):
    ...
    def _install(self, translations: "_SupportedTranslations", newstyle: bool | None = None) -> None:
    ...
    def _parse_block(self, parser: "Parser", allow_pluralize: bool) -> tuple[list[str], str]:
...
class _CommentFinder:
    ...
    def __init__(self, tokens: t.Sequence[tuple[int, str, str]], comment_tags: t.Sequence[str]) -> None:
        self.tokens = tokens
