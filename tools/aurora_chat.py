...
class AuroraChatInterface:
    ...
    def __init__(self, aurora_core=None):
        ...
        if BRIDGE_AVAILABLE:
            ...
            print(f"[Aurora Chat] Luminar Nexus Status: {status['services_available']}/{status['total_services']} services available")
...
def run_aurora_chat_server(port: int = 5003, aurora_core=None) -> Any:
    ...
    print(f"   GET  /api/status       - Status and stats")
    print(f"   GET  /api/context/<id> - Get session context")
