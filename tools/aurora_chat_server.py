...
def run_chat_server(port: int = 5003, project: str = "Aurora-Main"):
    ...
    print(f"  - Chat: POST http://127.0.0.1:{port}/api/chat")
    print(f"  - Remember: POST http://127.0.0.1:{port}/api/remember")
    print(f"  - Recall: GET http://127.0.0.1:{port}/api/recall?key=...")
    print(f"  - Facts: GET http://127.0.0.1:{port}/api/facts")
    print(f"  - Context: GET http://127.0.0.1:{port}/api/context")
    print(f"  - Search: POST http://127.0.0.1:{port}/api/search")
    print(f"  - Stats: GET http://127.0.0.1:{port}/api/stats")
    print("=" * 60)
