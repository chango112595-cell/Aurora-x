...
def get_git_file_content(file_path: str, revision: str = 'HEAD~1') -> Optional[str]:
    """
...
def compare_progress(current_file: Path, previous_content: Optional[str]) -> Tuple[float, float, bool]:
    """
...
def main():
    ...
    if has_regression:
        ...
        print(f"➖ No change in overall progress")
