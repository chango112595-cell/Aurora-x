...
def route_via_luminar_v2(message: str, session_id: str = "default") -> str | None:
    """
...
def route_via_luminar_v3(message: str, session_id: str = "default") -> str | None:
    """
        ...
        try:
            ...
            try:
                ...
                if response and len(response.strip()) > 0:
                    print("[Bridge] Routed via local Aurora Core")
                    return response
                else:
