...
class Test_fibonacci_0(unittest.TestCase):
    """
        ...
        Comprehensive class providing test fibonacci 0 functionality.
...
class Test_fibonacci_1(unittest.TestCase):
    """
        ...
        Comprehensive class providing test fibonacci 1 functionality.
...
class Test_fibonacci_2(unittest.TestCase):
    """
        ...
        Comprehensive class providing test fibonacci 2 functionality.
