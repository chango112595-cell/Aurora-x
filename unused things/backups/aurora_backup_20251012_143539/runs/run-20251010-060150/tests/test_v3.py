...
class Test_factorial_0(unittest.TestCase):
    """
        ...
        Comprehensive class providing test factorial 0 functionality.
...
class Test_factorial_1(unittest.TestCase):
    """
        ...
        Comprehensive class providing test factorial 1 functionality.
...
class Test_factorial_2(unittest.TestCase):
    """
        ...
        Comprehensive class providing test factorial 2 functionality.
