...
def detect_intent(message: str) -> str:
    ...
    code_keywords = [
        ...
        "function", "script", "program", "web", "api", "cli", "service"
    ]
...
What would you like to do? 😊"""
    ...
    return f"That's interesting! 🤔 Are you looking for me to generate some code, answer a question, or just chatting? Let me know how I can help!"
...
def generate_question_response(message: str) -> str:
    ...
    if "why" in msg_lower:
        return "Good question! 💭 There are usually multiple reasons. Can you be more specific about what you're asking?"
...
def generate_code_response(message: str) -> tuple[str, dict]:
    ...
    """
    return f"🌟 I got it! I can create that for you. Let me generate the code now...", {
        "message": message,
    ...
    try:
        ...
        if not message:
            return ConversationResponse(
                ok=False,
                response="I'm listening... What would you like to say? 👂",
                type="chat"
            )
...
What would you like to do? 🎯"""
                ...
                response_text = "✅ Everything's running great! Aurora's ready to go. What would you like me to create? 🚀"
        ...
        return ConversationResponse(
            ok=False,
            response=f"Hmm, something went wrong. {str(e)} Let me try again! 🔧",
            type="chat"
        )
