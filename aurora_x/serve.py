    ...
    try:
        ...
        if parsed.get("framework") == "flask":
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to import Flask synthesis module: {str(e)}") from e
        else:
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Failed to import synthesis module: {str(e)}") from e
